...
const missions: Record<string, MissionData> = {
  ...
  'new-horizons': {
    ...
    location: 'Kuiper Belt (58+ AU from Earth)',
    distance: '8.7 billion km from Earth',
    description: 'First mission to Pluto and continuing exploration of the Kuiper Belt. Currently the fastest spacecraft ever launched from Earth, traveling at 16.26 km/s relative to the Sun.',
    achievements: [
      ...
      'Fastest spacecraft launch speed from Earth',
    ...
    objectives: [
      'Study Pluto\'s atmosphere, surface, and moons',
      'Explore Kuiper Belt objects',
      'Collect heliophysics data from outer solar system',
      'Study solar wind interactions at extreme distances',
      'Search for additional Kuiper Belt targets',
    ],
    instruments: [
  ...
  'juno': {
    ...
    description: 'NASA\'s Jupiter orbiter studying the planet\'s interior structure, atmosphere, and magnetosphere from unique polar orbits. Extended through 2025 to study Jupiter\'s rings and inner moons.',
    achievements: [
      ...
      'Survived intense radiation environment',
      'Captured stunning close-up images of Jupiter\'s atmosphere',
    ],
    objectives: [
  ...
  'europa-clipper': {
    ...
    location: 'En Route to Jupiter (Expected Arrival: 2030)',
    distance: '2+ AU from Earth (increasing)',
    description: 'NASA\'s largest planetary science spacecraft ever built, en route to study Jupiter\'s moon Europa and its subsurface ocean. Will perform detailed reconnaissance to assess Europa\'s habitability.',
    achievements: [
      'Successfully launched on Falcon Heavy rocket',
      ...
      'Currently on 5.5-year journey to Jupiter system',
    ],
    objectives: [
  ...
  'lucy': {
    ...
    description: 'First mission to visit Jupiter\'s Trojan asteroids, ancient remnants from the formation of the solar system. Will visit 8 asteroids over 12 years, including the main belt asteroid Donaldjohanson.',
    achievements: [
      ...
      '12-year mission covering 6.3 billion km',
    ],
    objectives: [
  ...
  'psyche': {
    ...
    location: 'En Route to Asteroid Psyche (Expected Arrival: 2029)',
    distance: '1.8+ AU from Earth (increasing)',
    description: 'First mission to a metallic asteroid, targeting 16 Psyche - believed to be the exposed core of a protoplanet. Will study this unique metal-rich world to understand planetary formation.',
    achievements: [
      'Successfully launched on Falcon Heavy',
      'First mission to study a metallic asteroid',
      'Testing Deep Space Optical Communications',
      'Advanced ion propulsion system',
      'Six-year journey to main asteroid belt',
    ],
    objectives: [
  ...
  'osiris-apex': {
    ...
    location: 'En Route to Asteroid Apophis (Expected Arrival: 2029)',
    distance: '1.2+ AU from Earth (varies)',
    description: 'Extended mission of OSIRIS-REx after successfully returning samples from asteroid Bennu. Now heading to asteroid Apophis to study changes during its close Earth approach in 2029.',
    achievements: [
      'Successfully collected samples from asteroid Bennu (2020)',
      'First U.S. asteroid sample return mission (2023)',
      'Extended mission approved to study Apophis',
      'Will observe Apophis during rare close Earth approach',
