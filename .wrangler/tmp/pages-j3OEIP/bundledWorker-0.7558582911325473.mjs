...
var pe = /* @__PURE__ */ __name((t, e, s, r) => {
  if (e && typeof e == "object" || typeof e == "function") for (let i of oe(e)) !ue.call(t, i) && i !== s && A(t, i, { get: /* @__PURE__ */ __name(() => e[i], "get"), enumerable: !(r = ie(e, i)) || r.enumerable });
  return t;
}, "pe");
var D = /* @__PURE__ */ __name((t, e, s) => (s = t != null ? ne(ce(t)) : {}, pe(e || !t || !t.__esModule ? A(s, "default", { value: t, enumerable: true }) : s, t)), "D");
var x;
var u = C(() => {
  x = { collectedLocales: [] };
});
...
cookie/index.js:
   ...
   *)
*/
//# sourceMappingURL=bundledWorker-0.7558582911325473.mjs.map
