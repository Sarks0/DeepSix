...
var N = /* @__PURE__ */ __name((t, e) => () => (t && (e = t(t = 0)), e), "N");
var L = /* @__PURE__ */ __name((t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), "L");
var pe = /* @__PURE__ */ __name((t, e, s, r) => {
  if (e && typeof e == "object" || typeof e == "function") for (let i of oe(e)) !ue.call(t, i) && i !== s && V(t, i, { get: /* @__PURE__ */ __name(() => e[i], "get"), enumerable: !(r = ie(e, i)) || r.enumerable });
  return t;
}, "pe");
var O = /* @__PURE__ */ __name((t, e, s) => (s = t != null ? ne(ce(t)) : {}, pe(e || !t || !t.__esModule ? V(s, "default", { value: t, enumerable: true }) : s, t)), "O");
var x;
var u = N(() => {
  x = { collectedLocales: [] };
});
...
var Q = L((I) => {
  ...
  I.parse = Ne;
  I.serialize = $e;
  var Pe = Object.prototype.toString, Te = Object.prototype.hasOwnProperty, je = /^[!#$%&'*+\-.^_`|~0-9A-Za-z]+$/, ke = /^("?)[\u0021\u0023-\u002B\u002D-\u003A\u003C-\u005B\u005D-\u007E]*\1$/, Ce = /^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i, Se = /^[\u0020-\u003A\u003D-\u007E]*$/;
  function Ne(t, e) {
    ...
    do {
      ...
      var c = J(t, a, n), l = Z(t, n, c), h = t.slice(c, l);
      if (!Te.call(s, h)) {
        var _ = J(t, n + 1, o), g = Z(t, o, _);
  ...
  function $e(t, e, s) {
    ...
    if (s.domain) {
      if (!Ce.test(s.domain)) throw new TypeError("option domain is invalid");
      a += "; Domain=" + s.domain;
    }
    if (s.path) {
    ...
    if (s.expires) {
      var o = s.expires;
      if (!Ae(o) || isNaN(o.valueOf())) throw new TypeError("option expires is invalid");
...
function j(t, e, s) {
  ...
  let r = s ? "" : "i", i = [];
  return { match: (0, D.default)(`%${t}%${r}`, i).exec(e), captureGroupKeys: i };
}
__name(j, "j");
...
async function k(t, { request: e, assetsFetcher: s, ctx: r }, { path: i, searchParams: a }) {
  ...
  try {
    switch (t?.type) {
      ...
      case "override": {
        n = T(await s.fetch(A(c, t.path ?? i))), t.headers && y(n.headers, t.headers);
        break;
      }
      case "static": {
        n = await s.fetch(A(c, i));
        break;
      }
      default:
...
__name(_e, "_e");
async function K(t, { buildOutput: e, assetsFetcher: s, imagesConfig: r }) {
  let i = me(t, r);
...
async function G(t) {
  ...
  try {
    ...
    switch (t.method) {
      case "GET": {
        let a = z(t, ye), n = await r.get(i, { softTags: a });
      ...
      case "POST": {
        let a = globalThis[ge], n = /* @__PURE__ */ __name(async () => {
          let o = await t.json();
          o.data.tags === void 0 && (o.tags ??= z(t, xe) ?? []), await r.set(i, o);
        }, "n");
...
function we() {
  ...
  globalThis.fetch = async (...e) => {
    ...
    return r || (r = await G(s), r) ? r : (Re(s), t(s));
  };
}
__name(we, "we");
async function be(t) {
  if (t.url.startsWith("blob:")) try {
    let s = `./__next-on-pages-dist__/assets/${new URL(t.url).pathname}.bin`, r = (await C(s)).default, i = { async arrayBuffer() {
      return r;
    }, get body() {
...
var S = class {
  ...
  applyLocaleRedirects(e) {
    ...
    let { locale: { redirect: r, cookie: i } } = e, a = i && this.cookies[i], n = M(a ?? ""), o = M(this.reqCtx.request.headers.get("accept-language") ?? ""), h = [...n, ...o].map((_) => r[_]).filter(Boolean)[0];
    if (h) {
  ...
  async checkRoute(e, s) {
    ...
    if (n.check && !P(this.path)) if (h === this.path) {
      if (e !== "miss") return this.checkPhase(U(e));
      this.status = 404;
    } else if (e === "miss") {
  ...
  async checkPhase(e) {
    ...
    let i = "miss";
    return r || e === "miss" || e === "error" ? i = "hit" : s && (i = U(e)), this.checkPhase(i);
  }
  async run(e = "none") {
...
__name(se, "se");
async function Ue(t, { path: e = "/404", status: s, headers: r, searchParams: i, body: a }, n) {
...
d();
function re() {
  globalThis.__nextOnPagesRoutesIsolation ??= { _map: /* @__PURE__ */ new Map(), getProxyFor: Ie };
}
__name(re, "re");
function Ie(t) {
...
cookie/index.js:
   ...
   *)
*/
//# sourceMappingURL=bundledWorker-0.37896151762351593.mjs.map
