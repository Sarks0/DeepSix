...
var C = /* @__PURE__ */ __name((t, e) => () => (t && (e = t(t = 0)), e), "C");
var L = /* @__PURE__ */ __name((t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), "L");
var pe = /* @__PURE__ */ __name((t, e, s, r) => {
  if (e && typeof e == "object" || typeof e == "function") for (let i of oe(e)) !ue.call(t, i) && i !== s && H(t, i, { get: /* @__PURE__ */ __name(() => e[i], "get"), enumerable: !(r = ie(e, i)) || r.enumerable });
  return t;
}, "pe");
var O = /* @__PURE__ */ __name((t, e, s) => (s = t != null ? ne(ce(t)) : {}, pe(e || !t || !t.__esModule ? H(s, "default", { value: t, enumerable: true }) : s, t)), "O");
var x;
var u = C(() => {
  x = { collectedLocales: [] };
});
  ...
  function le(t, e) {
    ...
    for (let a = 0; a < t.length; a++) {
      ...
      switch (n) {
        ...
        case ")":
          if (r > 0 && (r--, r === 0)) {
            let o = a + 1, c = s === 0 ? "" : t.substring(0, s), h = t.substring(o), l = String(e(t.substring(s, o)));
            t = c + l + h, a = s;
          }
          break;
        case "\\":
...
var Q = L((q) => {
  ...
  q.parse = Ce;
  q.serialize = $e;
  var Pe = Object.prototype.toString, Te = Object.prototype.hasOwnProperty, je = /^[!#$%&'*+\-.^_`|~0-9A-Za-z]+$/, ke = /^("?)[\u0021\u0023-\u002B\u002D-\u003A\u003C-\u005B\u005D-\u007E]*\1$/, Se = /^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i, Ne = /^[\u0020-\u003A\u003D-\u007E]*$/;
  function Ce(t, e) {
    if (typeof t != "string") throw new TypeError("argument str must be a string");
    var s = {}, r = t.length;
    if (r < 2) return s;
    var i = e && e.decode || Ee, a = 0, n = 0, o = 0;
    do {
      ...
      var c = Z(t, a, n), h = X(t, n, c), l = t.slice(c, h);
      if (!Te.call(s, l)) {
        var _ = Z(t, n + 1, o), g = X(t, o, _);
  ...
  function $e(t, e, s) {
    ...
    var i = r(e);
    if (!ke.test(i)) throw new TypeError("argument val is invalid");
    var a = t + "=" + i;
    if (!s) return a;
    if (s.maxAge != null) {
    ...
    if (s.domain) {
      if (!Se.test(s.domain)) throw new TypeError("option domain is invalid");
      a += "; Domain=" + s.domain;
    }
    if (s.path) {
      if (!Ne.test(s.path)) throw new TypeError("option path is invalid");
      a += "; Path=" + s.path;
    }
    if (s.expires) {
      var o = s.expires;
      if (!Me(o) || isNaN(o.valueOf())) throw new TypeError("option expires is invalid");
...
function j(t, e, s) {
  ...
  let r = s ? "" : "i", i = [];
  return { match: (0, U.default)(`%${t}%${r}`, i).exec(e), captureGroupKeys: i };
}
__name(j, "j");
function R(t, e, s, { namedOnly: r } = {}) {
...
__name(R, "R");
function E(t, { url: e, cookies: s, headers: r, routeDest: i }) {
  switch (t.type) {
    case "host":
...
function $(t, e, s) {
  ...
  return s && r && i.length ? { valid: !!r, newRouteDest: R(s, r, i, { namedOnly: true }) } : { valid: !!r };
}
__name($, "$");
u();
p();
...
function y(t, e, s) {
  ...
  for (let [i, a] of r) {
    let n = i.toLowerCase(), o = s?.match ? R(a, s.match, s.captureGroupKeys) : a;
...
__name(A, "A");
async function k(t, { request: e, assetsFetcher: s, ctx: r }, { path: i, searchParams: a }) {
    ...
    switch (t?.type) {
      ...
      case "middleware": {
        ...
        try {
          ...
          let _ = l;
          throw _.name === "TypeError" && _.message.endsWith("default is not a function") ? new Error(`An error occurred while evaluating the target edge function (${t.entrypoint})`) : l;
        }
        break;
      }
      case "override": {
        n = T(await s.fetch(M(c, t.path ?? i))), t.headers && y(n.headers, t.headers);
        break;
      }
      case "static": {
        n = await s.fetch(M(c, i));
        break;
      }
      default:
...
function me(t, e) {
  ...
  let c = i.startsWith("//"), h = i.startsWith("/") && !c;
  if (!h && !e?.domains?.includes(o.hostname) && !e?.remotePatterns?.find((g) => fe(o, g))) return;
  let l = t.headers.get("Accept") ?? "", _ = e?.formats?.find((g) => l.includes(g))?.replace("image/", "");
  return { isRelative: h, imageUrl: o, options: { width: a, quality: n, format: _ } };
}
__name(me, "me");
function _e(t, e, s) {
  let r = new Headers();
...
async function W(t) {
  ...
  try {
    ...
    switch (t.method) {
      ...
      case "POST": {
        let a = globalThis[ge], n = /* @__PURE__ */ __name(async () => {
          let o = await t.json();
...
__name(ve, "ve");
async function z(t) {
  let e = `./__next-on-pages-dist__/cache/${t}.js`, s = await S(e);
...
__name(G, "G");
function J() {
  globalThis[Y] || (we(), globalThis[Y] = true);
}
__name(J, "J");
function we() {
  let t = globalThis.fetch;
  globalThis.fetch = async (...e) => {
    let s = new Request(...e), r = await be(s);
    return r || (r = await W(s), r) ? r : (Re(s), t(s));
  };
}
__name(we, "we");
async function be(t) {
  if (t.url.startsWith("blob:")) try {
    let s = `./__next-on-pages-dist__/assets/${new URL(t.url).pathname}.bin`, r = (await S(s)).default, i = { async arrayBuffer() {
      return r;
    }, get body() {
...
var N = class {
  ...
  checkRouteMatch(e, { checkStatus: s, checkIntercept: r }) {
    ...
    }) && !e.missing?.find((n) => E(n, a).valid) && !(s && e.status !== this.status)) {
      if (r && e.dest) {
  ...
  processMiddlewareResp(e) {
    ...
    if (r) {
      ...
      for (let h of c.keys()) {
        let l = `x-middleware-request-${h}`, _ = e.headers.get(l);
        this.reqCtx.request.headers.get(h) !== _ && (_ ? this.reqCtx.request.headers.set(h, _) : this.reqCtx.request.headers.delete(h)), e.headers.delete(l);
      }
      e.headers.delete(s);
    }
    let i = "x-middleware-rewrite", a = e.headers.get(i);
    if (a) {
      let c = new URL(a, this.url), h = this.url.hostname !== c.hostname;
      this.path = h ? `${c}` : c.pathname, v(this.searchParams, c.searchParams), e.headers.delete(i);
    }
  ...
  applyRouteDest(e, s, r) {
    ...
    this.wildcardMatch && /\$wildcard/.test(a) && (a = a.replace(/\$wildcard/g, this.wildcardMatch.value)), this.path = R(a, s, r);
    let n = /\/index\.rsc$/i.test(this.path), o = /^\/(?:index)?$/i.test(i), c = /^\/__index\.prefetch\.rsc$/i.test(i);
    n && !o && !c && (this.path = i);
    let h = /\.rsc$/i.test(this.path), l = /\.prefetch\.rsc$/i.test(this.path), _ = this.path in this.output;
    h && !l && !_ && (this.path = this.path.replace(/\.rsc/i, ""));
  ...
  applyLocaleRedirects(e) {
    ...
    let { locale: { redirect: r, cookie: i } } = e, a = i && this.cookies[i], n = I(a ?? ""), o = I(this.reqCtx.request.headers.get("accept-language") ?? ""), l = [...n, ...o].map((_) => r[_]).filter(Boolean)[0];
    if (l) {
  ...
  async checkRoute(e, s) {
    ...
    if (n.check && !P(this.path)) if (l === this.path) {
  ...
  async checkPhase(e) {
    ...
    let i = "miss";
    return r || e === "miss" || e === "error" ? i = "hit" : s && (i = A(e)), this.checkPhase(i);
  }
  async run(e = "none") {
...
async function te(t, e, s, r) {
  let i = new N(e.routes, s, t, r, e.wildcard), a = await se(i);
  return Ae(t, a, s);
}
__name(te, "te");
...
__name(se, "se");
async function Ae(t, { path: e = "/404", status: s, headers: r, searchParams: i, body: a }, n) {
  let o = r.normal.get("location");
  if (o) {
    if (o !== r.middlewareLocation) {
      let l = [...i.keys()].length ? `?${i.toString()}` : "";
  ...
  if (a !== void 0) c = new Response(a, { status: s });
    ...
    let l = new URL(e);
    v(l.searchParams, i), c = await fetch(l, t.request);
  } else c = await k(n[e], t, { path: e, status: s, headers: r, searchParams: i });
  let h = r.normal;
...
d();
function re() {
  globalThis.__nextOnPagesRoutesIsolation ??= { _map: /* @__PURE__ */ new Map(), getProxyFor: qe };
}
__name(re, "re");
function qe(t) {
...
function He() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name((e, s) => t.has(s) ? t.get(s) : Reflect.get(globalThis, s), "get"), set: /* @__PURE__ */ __name((e, s, r) => Le.has(s) ? Reflect.set(globalThis, s, r) : (t.set(s, r), true), "set") });
}
__name(He, "He");
var Le = /* @__PURE__ */ new Set(["_nextOriginalFetch", "fetch", "__incrementalCache"]);
var Oe = Object.defineProperty;
var Fe = /* @__PURE__ */ __name((...t) => {
  let e = t[0], s = t[1], r = "__import_unsupported";
  if (!(s === r && typeof e == "object" && e !== null && r in e)) return Oe(...t);
}, "Fe");
globalThis.Object.defineProperty = Fe;
...
var $s = { async fetch(t, e, s) {
  ...
  return i.run({ ...e, NODE_ENV: "production", SUSPENSE_CACHE_URL: b }, async () => a.run({ env: e, ctx: s, cf: t.cf }, async () => {
...
cookie/index.js:
   ...
   *)
*/
//# sourceMappingURL=bundledWorker-0.4477171966616016.mjs.map
